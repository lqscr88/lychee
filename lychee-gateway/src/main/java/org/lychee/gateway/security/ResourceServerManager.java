package org.lychee.gateway.security;
...
import org.lychee.common.constant.GlobalConstant;
import org.lychee.common.constant.SecurityConstant;
...
public class ResourceServerManager implements ReactiveAuthorizationManager<AuthorizationContext> {
    ...
    public Mono<AuthorizationDecision> check(Mono<Authentication> mono, AuthorizationContext authorizationContext) {
        ...
        if (StrUtil.isNotBlank(token) && StrUtil.startWithIgnoreCase(token, SecurityConstant.JWT_PREFIX) ) {
...
//            }
        ...
        Mono<AuthorizationDecision> authorizationDecisionMono = mono
                ...
                .any(authority -> {
                    String roleCode = StrUtil.removePrefix(authority,SecurityConstant.AUTHORITY_PREFIX);// ROLE_ADMIN移除前缀ROLE_得到用户的角色编码ADMIN
